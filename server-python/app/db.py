...
-- rank_check_log's composite index leads with user_id, so project-scoped
-- cascades couldn't use it.
CREATE INDEX IF NOT EXISTS idx_rank_check_log_project
  ON rank_check_log (project_id);
